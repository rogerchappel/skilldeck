...
Replace this section with the supported versions for `skilldeck`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `skilldeck` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in .worktrees/skilldeck-main.
