...
- [x] Copy source PRD into `docs/PRD.md`.
...
- [x] Implement docs-to-skill pack creation.
- [x] Add fixtures for valid and invalid packs.
- [x] Add unit tests and CLI smoke checks.
- [x] Document local-first safety posture.
- [x] Add examples and contributor/security docs.
