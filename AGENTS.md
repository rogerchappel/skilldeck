# Agent Operating Instructions for skilldeck

This file defines how AI agents and human maintainers should work in `skilldeck`.

## Project Context

- Project: `skilldeck`
- Repository: `https://github.com/rogerchappel/skilldeck`
- Primary maintainer: ``
- Default branch: ``
- Package manager: ``
- Primary verification command: `npm test && bash scripts/validate.sh`
...
6. Run `npm test && bash scripts/validate.sh` or a smaller targeted check when appropriate.
7. Commit atomically.
